...
def build_gemini_payload(current_question, display_name, wellness_list):
   ...
   system_instructions = (
        ...
        "To ensure workouts parse cleanly into structured step charts for MyWhoosh and Garmin, follow these strict Intervals.icu text rules:\n"
        "1. DO NOT use nested sub-bullets under repetition blocks. Intervals.icu parser fails on deep indentation.\n"
        "2. For repetition blocks, write them cleanly using repeat multipliers or flat sequential lines.\n"
        ...
        "     Cooldown\n"
        "     - 10m 50%\n\n"
        "3. For Running (Garmin compatible):\n"
        "     Warmup\n"
        "     - 15m Z2 Pace\n\n"
        "     Main Set\n"
        "     - 4x (1km Threshold Pace / 90s Jog Recovery)\n\n"
        "     Cooldown\n"
        "     - 10m Easy\n\n"
